...
public class InvalidMemberRegister {
    ...
    static String scenario = new String("Check student Resgister with invalid data");
    static String expectedResult = new String("http://localhost/library-master/student_form.php");
    static File tests = new File("memberRegisterTests/invalidTests.txt");
    ...
    public static void start()  {
        ...
        while(cin.hasNext()) {
            ...
            summary.setId("InvldStdntRgstr"+cnt++);
