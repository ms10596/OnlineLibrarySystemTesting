...
public class InvalidTeacherRegister {
    ...
    static String scenario = new String("Check teacher Register with invalid data");
    static String expectedResult = new String("http://localhost/library-master/teacher_form.php");
    static File tests = new File("teacherRegisterTests/invalidTests.txt");
    ...
    public static void start()  {
        ...
        while(cin.hasNext()) {
            ...
            summary.setId("InvldTchrRgstr"+cnt++);
