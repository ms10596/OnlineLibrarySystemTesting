...
public class ValidLoginTesting{
    ...
    static String scenario = new String("Check student login with valid data");
    static String expectedResult = new String("http://localhost/library-master/member/dashboard.php");
    static File tests = new File("loginTests/validTests.txt");
